...
const { RegisterUser, getAll, getSingleUser, signInUser, updateUser, deleteUser, verifyUser, verifyUser2, getAllCustomers } = require("../Controller/UserCont/userController");
